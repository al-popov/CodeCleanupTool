...
@Component
@Log4j2
class DeadCodeReport implements StatisticsReport {
    ...
    DeadCodeReport(CoverageMethodStatistic coverageMethodStatistic,
                   ProjectConfiguration projectConfiguration) {

        this.reportName = "dead-code"
